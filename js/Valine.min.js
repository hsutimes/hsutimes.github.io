        ...
        */
        ...
        r.prototype.init = function (e) {
            ...
            try {
                ...
                T = e.config.serverURLs || z + "avoscloud.com", M !== AV._config.applicationId && C !==
        ...
        r.prototype.Q = function (e) {
            ...
            t.Q(y).count().then(function (e) {
                e > 0 ? (u.attr(u.find(t.el, ".vinfo"), "style", "display:block;"), u.find(
                    ...
                    "</span> " + t.locale.tips.comments, M()) : t.loading.hide()
            }).catch(function (e) {
                t.ErrorHandler(e)
            });
            var C = function (e, n, r) {
                    ...
                    "*" === y && (l = '<a href="' + e.get("url") + '" class="vsys">' + e.get("url") +
                        "</a>");
                    var p = "",
                        f = e.get("link") || "";
            ...
            var B = function () {
                    v.comment = "", _.comment.value = "", w(_.comment), u.attr(_.comment,
                ...
                U = function (e) {
                    ...
                    }) : "" == v.comment ? void _.comment.focus() : (v.nick = v.nick ||
                        "Anonymous", void(t.notify || t.verify ? Q(N) : N()))
                },
                I = function () {
                    var e = new AV.ACL;
                ...
                N = function () {
                    ...
                    if (v.url = decodeURI(r), v.insertedAt = new Date, R.rid) {
                        var i = R.pid || R.rid;
                        n.set("rid", R.rid), n.set("pid", i), v.comment = v.comment.replace("<p>",
                    ...
                    for (var o in v)
                        ...
                        try {
                            if (R.rid) {
                                var i = u.find(t.el, '.vquote[rid="' + R.rid + '"]') || L(R
                                    .rid);
                                C(e, i, !0)
            ...
            u.on("click", P, U), u.on("keydown", document, function (e) {
                ...
                ((e.ctrlKey || e.metaKey) && 13 === t && U(), 9 === t) && ("veditor" == (
